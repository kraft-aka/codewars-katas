...
character count requirements of the Kata. (no more than 85) You may assume that all array elements are unique.
*/

const find = (array, el) =>
  array.indexOf(el) == -1 ? "Not found" : array.indexOf(el);
