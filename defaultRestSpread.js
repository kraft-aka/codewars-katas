...
// undefined. If in the following example, no value is provided for b in the call, its value would be undefined when evaluating a*b and the call
// to multiple would have returned NaN. However, this is caught with the second line in this example:
...
// }
// multiply(5); // 5
// With default parameters, the check in the function body is no longer necessary. Now, you can simply put 1 as the default value for b in the
//  function head:
...
// multiply(5); // 5
// Rest
// Rest parameters have been introduced to reduce the boilerplate code that was induced by the arguments ```javascript // Before rest parameters,
//  the following could be found: function f(a, b){ var args = Array.prototype.slice.call(arguments, f.length); // ... }
...
// Using the indicated feature, implement a function that achieves the following results: ```javascript function defaultExample(x, y)
// { return //complete this function } defaultExample(3) // 10
