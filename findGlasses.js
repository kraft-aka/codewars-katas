...
// This means that both O--O and O------------O are valid glasses, but not O----#--O
// for example!
...
// Notes
// All lists will include one valid pair of glasses because I swear I dropped them
// around here somewhere ...
// All elements in the list are strings.

function findGlasses(arr) {
  return arr.findIndex((glass) => glass.match(/O-+O/));
}
