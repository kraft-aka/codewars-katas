// Let's say that "g" is happy in the given string, if there is another "g"
// immediately to the right or to the left of it.
...
function gHappy(str) {
  let allG = str.match(/g+/g) || [];
  return allG.every((w) => w.length > 1);
}
