// A sequence or a series, in mathematics, is a string of objects, like numbers, that follow a particular pattern. The individual elements
// in a sequence are called terms. A simple example is 3, 6, 9, 12, 15, 18, 21, ..., where the pattern is: "add 3 to the previous term".
...
function sumOfN(n) {
  ...
  for (let i = 1; i <= Math.abs(n); i++) {
    arr.push(arr[i - 1] + i * Math.sign(n));
  }
  return arr;
}
