...
// Write a function area_code() that finds and returns just the area
// code portion of the phone number.
...
// and the only non-alphanumeric characters in the string are apostrophes '
