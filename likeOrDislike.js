...
// It was set up in such a way that you cannot like and dislike a video at the same time. There are two other interesting
// rules to be noted about the interface: Pressing a button, which is already active, will undo your press.
...
function likeOrDislike(buttons) {
  ...
  return state !== "Nothing" ? state : "Nothing";
}
