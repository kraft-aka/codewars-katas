...
// When Bob switches the gravity, it begins to pull all the cubes to a certain side
// of the box, d, which can be either 'L' or 'R' (left or right). Below is an
// example of what a box of cubes might look like before and after switching gravity.
...
console.log(flip('L',[10,2,5,99]))
console.log(flip('R',[10,2,5,99]))