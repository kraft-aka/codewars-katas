// This should be fairly simple. It is more of a puzzle than a
// programming problem.

// There will be a string input in this format: 'a+b' 2
// lower case letters (a-z) seperated by a '+'
...
// It is like when you were in school doing math and you saw
// "11 = c+h" and you needed to find out what c and h were.
...
function theVar(theVariables) {
  const [first, , second] = theVariables;
  const letters = "-abcdefghijklmnopqrstuvwxyz";
  return letters.indexOf(first) + letters.indexOf(second);
}
