...
// Create a function, killcount, that accepts two arguments: an array of array pairs (the conselor's name and intelligence - ["Chad", 2])
...
function killcount(counselors, jason) {
  return counselors.filter((i) => i[1] < jason).map((i) => i[0]);
}
