...
// Example
// ['Mango', 'Banana', 'Avocado'] //the price of this juice bottle is (7+5+7)/3 = $6
...
function mixFruit(arr) {
  ...
  for (const fruit of arr) {
    const fruitItem = fruit.toLowerCase();
    fruits.hasOwnProperty(fruitItem)
      ? (totalSum += fruits[fruitItem])
      : (totalSum += 9);
  }
